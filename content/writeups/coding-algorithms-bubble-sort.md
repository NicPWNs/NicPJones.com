...
<figure><img src="/writeups/coding-algorithms-bubble-sort/img-1.png" alt="A visual representation of bubble sort." /><figcaption>A visual representation of bubble sort.</figcaption></figure>
<h3>Logical Steps</h3>
...
<figure><img src="/writeups/coding-algorithms-bubble-sort/img-2.gif" alt="Bubble sort in action for a small list." /><figcaption>Bubble sort in action for a small list.</figcaption></figure>
<h3>Big-O Complexity</h3>
<figure><img src="/writeups/coding-algorithms-bubble-sort/img-3.png" alt="Big-O Complexity" /><figcaption>Big-O Complexity</figcaption></figure>
...
<h4>Avoid Looping Through Already Sorted Values</h4>
    ...
    for j in range(len(elements)-1):
        ...
        for i in range(len(elements)-1-j):
            ...
            if elements[i] &gt; elements[i+1]:
                ...
                # Set the next element to the original elements of the first element
                elements[i+1] = tmp</code></pre>
<h4>Stop Looping Through a Sorted Array</h4>
